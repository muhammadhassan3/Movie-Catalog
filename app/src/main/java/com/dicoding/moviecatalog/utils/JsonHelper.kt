...
object JsonHelper {
    ...
    fun loadMovieListFromJson(jsonString: String): TmdbModel<MovieModelJson> =
        jsonBuilder.decodeFromString(jsonString)

    fun loadSeriesListFromJson(jsonString: String): TmdbModel<SeriesModelJson> =
        jsonBuilder.decodeFromString(jsonString)

    fun loadMovieModelFromJson(jsonString: String): MovieModelJson =
        jsonBuilder.decodeFromString(jsonString)

    fun loadSeriesModelFromJson(jsonString: String): SeriesModelJson =
        jsonBuilder.decodeFromString(jsonString)

    fun loadTrendingModelFromJson(jsonString: String): TmdbModel<RandomModelJson> =
        jsonBuilder.decodeFromString(jsonString)

    fun loadSearchResultFromJson(jsonString: String): TmdbModel<RandomModelJson> =
        jsonBuilder.decodeFromString(jsonString)
